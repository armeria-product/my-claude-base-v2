...
- **bugfix** runs its fix→verify as the same Loop Contract: debugger/executor worker, verifier as the evidence gate, max 3 cycles, **internal** (no user between cycles)
