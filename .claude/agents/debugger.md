...
- If the fix requires work outside the plan, record the intent as one line in `plans/{slug}/deviations.md` and report it instead of expanding the task silently.
